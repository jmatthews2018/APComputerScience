...
public class Problem7 {
	...
	public static void main(String[] args) {
		...
		System.out.println("     'much' better if you learn"); //\t is too big to replicate the text so spaces are used
		System.out.println("the rules of \"escape sequences.\""); //same as above for double quotes
		System.out.println("     Also, \"\" represents an empty String."); // \"\" = "". \t cannot be used again as it is too big
